...
from _task_api import first_output_url, list_motion_tasks, list_photo_tasks


def main():
    parser = argparse.ArgumentParser(description="列出文生数字人任务列表")
    parser.add_argument("--kind", choices=["photo", "motion"], default="photo", help="任务类型，默认 photo")
